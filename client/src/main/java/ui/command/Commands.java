...
public abstract class Commands {
    ...
    public static UICommand LEAVE = new UICommand("leave", "Leave the current game", AuthorizationRole.OBSERVER);
    ...
    public static UICommand HIGHLIGHT_MOVES = new UICommand("highlight", "Highlight available moves",
            AuthorizationRole.PLAYER);
    ...
    public static UICommand[] UI_COMMANDS = {HELP, QUIT, REGISTER, LOGIN, LOGOUT, CREATE_GAME, LIST_GAMES, JOIN_GAME,
            OBSERVE_GAME, DRAW, LEAVE, MAKE_MOVE, RESIGN, HIGHLIGHT_MOVES};

...
/**
 * Provides the Join Game service, which connects a user to an existing game as
 * either a player or spectator. This request is idempotent.
 */
public class JoinGameService {

    /**
     * Connect a user to an existing game as either a player or spectator.
     ...
     * specified the user is joined as an observer. This request is idempotent.
     *
